...
// Hiển thị chi tiết đơn hàng và thao tác cập nhật trạng thái.
const OrderDetail = () => {
    ...
    return (
        <LoadingLayout loading={loading}>
            <div className="min-h-screen flex justify-center items-center bg-gray-100 dark:bg-gray-800 p-8">
                <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg max-w-2xl w-full p-6 space-y-6">
                ...
                {order && order.orderProduct && (
                    ...
                    <div className="mt-8 space-y-4">
                        <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-300">Sản phẩm trong đơn hàng</h3>
                        ...
                        <div key={item.id} className="flex items-center justify-between border-b pb-4 dark:border-gray-700">
                            ...
                            <div>
                                ...
                                <span className="block text-sm font-semibold text-gray-900 dark:text-white">
                                    {item.productName} {item.productType ? ' - ' + item.productType : ''}
                                </span>
                                </div>
                                <div>
                                {item.saleRate > 0 ? (
                                    ...
                                    <div>
                                    <span className="text-gray-800 dark:text-gray-300 font-semibold">{formatLargeNumber(item.price)}</span>
                                    </div>
                                )}
                                </div>
                            </div>
                            </div>
                            <div className="text-sm text-gray-800 dark:text-gray-300 text-right">
                    ...
                    <div className="mt-8 space-y-4">
                        ...
                        <div className="flex justify-between text-gray-800 dark:text-gray-300 font-semibold">
